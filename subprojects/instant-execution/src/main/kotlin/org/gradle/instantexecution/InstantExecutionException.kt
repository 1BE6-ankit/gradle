...
class InstantExecutionErrorsException(summary: String, problems: List<PropertyProblem>) : InstantExecutionException(
    "${MESSAGE}\n$summary",
...
@Contextual
class InstantExecutionErrorException(message: String, cause: Throwable? = null) : Exception(message, cause)
